...
contains
   ...
   subroutine geometry_init
      ...
      create_block1: block
         ...
         call param_read('1 Pipe diameter',Dout)
         ...
         grid=sgrid(coord=cartesian,no=2,x=x,y=y,z=z,xper=.true.,yper=.true.,zper=.true.,name='turb_pipe')
         ! Read in partition
         ...
         do k=cfg1%kmino_,cfg1%kmaxo_
            do j=cfg1%jmino_,cfg1%jmaxo_
               do i=cfg1%imino_,cfg1%imaxo_
                  ...
                  cfg1%Gib(i,j,k)=radius-0.5_WP*Dout
               end do
            end do
         end do
         !> Get normal vector
      ...
      create_block2: block
         ...
         ! General serial grid object
         grid=sgrid(coord=cartesian,no=3,x=x,y=y,z=z,xper=.false.,yper=.true.,zper=.true.,name='jet')
         ! Read in partition
