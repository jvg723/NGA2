...
module multiscalar_class
   ...
   type :: multiscalar
      ...
      type(ils) :: implicit                               !< Iterative linear solver object for an implicit prediction of the multiscalar residual
...
contains
   ...
   subroutine setup(this,implicit_ils)
      ...
      ! Set dynamic stencil map for the multiscalar solver
      ...
      ! Initialize the implicit multiscalar solver
