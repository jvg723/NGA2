...
module vfs_class
   ...
   type :: vfs
      ...
      real(WP), dimension(:,:,:), allocatable :: curvness !< Gaussian curvature
...
contains
   ...
   subroutine initialize(this,cfg,reconstruction_method,transport_method,name)
      ...
      allocate(this%curvness (  this%cfg%imino_:this%cfg%imaxo_,this%cfg%jmino_:this%cfg%jmaxo_,this%cfg%kmino_:this%cfg%kmaxo_)); this%curvness =0.0_WP
      ...
      ! Move allocation outside two plane init
