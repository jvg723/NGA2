...
module simulation
   ...
   type(monitor) :: mfile,cflfile,scfile,filmfile
...
contains
   ...
   subroutine simulation_init
      ...
      create_monitor: block
         ...
         call scfile%write()
         ! Create a film monitor file
         filmfile=monitor(fs%cfg%amRoot,'film')
         call filmfile%add_column(time%n,'Timestep number')
