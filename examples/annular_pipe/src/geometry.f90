...
contains
   ...
   subroutine geometry_init
      ...
      create_grid: block
         ...
         call param_read('Outer Pipe diameter',D2)
         call param_read('Inner Pipe diameter',D1)
      ...
      create_cfg: block
         ...
         use pgrid_class, only: p3dfft_decomp,default_decomp
         ...
         cfg=config(grp=group,decomp=partition,grid=grid,strat=default_decomp)
