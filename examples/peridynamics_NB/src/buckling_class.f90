...
contains
   ...
   subroutine init(this)
      ...
      implicit none
      class(buckling), intent(inout) :: this
      
      ! Read the input
      this%input=inputfile(amRoot=amRoot,filename='input_buckling')
      ...
      initialize_lss: block
         ...
         Lx=0.004_WP; Ly=0.001_WP; Lz=0.001_WP
      ...
      create_ensight: block
         ...
         this%ens_out=ensight(cfg=this%cfg,name='buckling')
      ...
      create_monitor: block
         ...
         this%mfile=monitor(this%cfg%amRoot,'buckling')
