...
module simulation
   ...
   real(WP) :: visc_s,visc_p,visc_0,visc
...
contains
   ...
   subroutine simulation_init
      ...
      create_and_initialize_flow_solver: block
         ...
         call param_read('Dynamic viscosity',visc_s); fs%visc=visc_s
      ...
      ! Create a FENE model 
      create_fene: block
         use ils_class,  only: gmres,gmres_pilut
         ...
         fm%implicit%maxit=vs%maxit; fm%implicit%rcvg=vs%rcvg
         ! Setup the solver
      ...
      create_ensight: block
         ...
         call ens_out%add_scalar('f_r',fm%f_r)
         call ens_out%add_scalar('CgradU1',fm%CgradU(:,:,:,1))
         call ens_out%add_scalar('CgradU2',fm%CgradU(:,:,:,2))
         call ens_out%add_scalar('CgradU3',fm%CgradU(:,:,:,3))
         call ens_out%add_scalar('CgradU4',fm%CgradU(:,:,:,4))
         call ens_out%add_scalar('CgradU5',fm%CgradU(:,:,:,5))
         call ens_out%add_scalar('CgradU6',fm%CgradU(:,:,:,6))
         ! Output to ensight
